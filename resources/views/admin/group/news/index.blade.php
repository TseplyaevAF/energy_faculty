      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-1 mb-3">
            <a href="{{ route('admin.group.news.create') }}" class="btn btn-block btn-primary">Создать</a>
          </div>
        </div>

        <div class="row">
          <div class="col-1 mb-3">
            <a href="{{ route('admin.group.news.cart.index') }}" class="btn btn-block btn-danger">Корзина</a>
          </div>
        </div>
                ...
                <table class="table table-hover text-wrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      @endif
                      <td><a href="{{ route('admin.group.news.show', $news->id) }}"><i class="far fa-eye"></i></a></td>
                      <td><a href="{{ route('admin.group.news.edit', $news->id) }}" class="text-success"><i class="far fa-edit"></i></a></td>
                      <td>
